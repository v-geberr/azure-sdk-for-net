...
namespace Microsoft.Azure.CognitiveServices.Language.LUIS.Programmatic.Models
{
    ...
    public partial class EntityExtractor : ModelInfo
    {
        ...
        public EntityExtractor(string readableType, string id = default(string), string name = default(string), double? typeId = default(double?), string customPrebuiltDomainName = default(string), string customPrebuiltModelName = default(string))
